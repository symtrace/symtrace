...
| Metric / Scenario | Baseline | `symtrace` v0.4.0 | Performance |
| :--- | :--- | :--- | :--- |
...
| **Full Test Suite Run Time** | ~0.33s | **0.03s Unit / 0.11s Total** | 186 tests passed |
